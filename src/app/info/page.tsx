...
import { ShieldCheck, Lock, Zap, EyeOff, ArrowLeft } from 'lucide-react';
      ...
      <Card className="w-full max-w-3xl shadow-xl bg-card border-border text-foreground">
        <CardHeader className="text-center border-b border-border pb-4">
          <div className="inline-flex items-center justify-center mb-3">
            <Image src="/logo.png" alt="Wicker Logo" width={64} height={64} className="rounded-md" />
          </div>
          <CardTitle className="text-3xl font-bold text-primary font-headline">
            Wicker: Security & Privacy
          </CardTitle>
          <CardDescription className="text-md text-muted-foreground pt-1">
            Understanding how Wicker protects your conversations.
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-6 space-y-8">
          <section>
            <h2 className="text-xl font-semibold mb-2 flex items-center text-primary">
              <Lock size={20} className="mr-2" /> End-to-End Encryption (E2EE)
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              All messages in Wicker are end-to-end encrypted. This means that only you and the person you're communicating with can read what's sent, and nobody in between – not even Wicker. Your messages are encrypted on your device before they are sent and decrypted on the recipient's device. We use the robust AES-GCM encryption algorithm, deriving unique keys for each chat to ensure your conversations remain confidential.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-2 flex items-center text-primary">
              <Zap size={20} className="mr-2" /> Ephemeral Messaging
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Wicker embraces the principle of "leaving no trace." You have granular control over how long your messages exist:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-1 mt-2 pl-4">
              ...
              <li><strong>Manual Control:</strong> You can always choose "Never" for expiration if you wish for a message to persist until manually deleted or if the chat is cleared.</li>
            </ul>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 flex items-center text-primary">
              <EyeOff size={20} className="mr-2" /> Data Handling & Anonymity
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Wicker is designed with privacy at its core:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-1 mt-2 pl-4">
              ...
              <li><strong>Guest Access:</strong> You can use Wicker as a guest, further enhancing anonymity for casual conversations.</li>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-foreground">Our Commitment</h2>
            <p className="text-muted-foreground leading-relaxed">
